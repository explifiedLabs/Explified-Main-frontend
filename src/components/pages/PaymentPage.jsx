...
const normalizeCMSApp = (app, platformKey, index) => {
  const charCodeSum = (app.title || "")
    .split("")
    .reduce((sum, char) => sum + char.charCodeAt(0), 0);

  const isFlagship =
    app.ours ||
    FLAGSHIP_APP_TITLES.some(
      (t) => t.toLowerCase() === (app.title || "").trim().toLowerCase(),
    );

  const tag =
    app.tag ||
    (isFlagship ? "Our App" : charCodeSum % 2 === 0 ? "Free" : "Pro");
...
const MOCK_CMS_HEADER = {
  figma: {
    ...
    items: [
      {
        title: "Wireframer AI",
        desc: "Instantly transforms text prompts into Figma wireframes.",
        iconUrl: "https://placehold.co/48x48/7c3aed/ffffff?text=W",
        tag: "Pro",
        requiresLogin: true,
        endorsed: true,
      },
      {
        ...
        desc: "Transforms Figma components into production-ready HTML/CSS.",
        iconUrl: "https://placehold.co/48x48/0ea5e9/ffffff?text=D",
        tag: "Free",
        requiresLogin: false,
        endorsed: false,
      },
      {
        title: "FrameEdit",
        desc: "All-in-one image editing and design toolkit for Figma.",
        iconUrl: "https://placehold.co/48x48/059669/ffffff?text=F",
        tag: "Free",
        requiresLogin: false,
        endorsed: false,
      },
      {
        title: "Font Dock",
        desc: "Browse, customize, and insert Font Awesome icons directly.",
        iconUrl: "https://placehold.co/48x48/d97706/ffffff?text=F",
        tag: "Free",
        requiresLogin: false,
        endorsed: false,
      },
      {
        ...
        desc: "Generate beautiful, customizable QR codes inside Figma.",
        iconUrl: "https://placehold.co/48x48/23b5b5/000000?text=Q",
        tag: "Our App",
        requiresLogin: true,
        endorsed: true,
        ours: true,
      },
      {
        ...
        desc: "Export frames, components, and assets with one click.",
        iconUrl: "https://placehold.co/48x48/6366f1/ffffff?text=S",
        tag: "Pro",
        requiresLogin: true,
        endorsed: true,
      },
  ...
  shopify: {
    ...
    items: [
      {
        title: "AnnounceMate",
        desc: "Create and manage custom announcement bars for your store.",
        iconUrl: "https://placehold.co/48x48/23b5b5/000000?text=A",
        tag: "Our App",
        requiresLogin: true,
        endorsed: true,
        ours: true,
      ...
      {
        title: "Form Maker",
        desc: "Create professional, customizable forms without code.",
        iconUrl: "https://placehold.co/48x48/f97316/ffffff?text=F",
        tag: "Free",
        requiresLogin: false,
        endorsed: false,
      },
      {
        title: "Judge.me",
        desc: "Collect, manage, and display customer reviews automatically.",
        iconUrl: "https://placehold.co/48x48/eab308/000000?text=J",
        tag: "Free",
        requiresLogin: false,
        endorsed: true,
      },
      {
        ...
        desc: "Add lightweight celebration effects and animations.",
        iconUrl: "https://placehold.co/48x48/ec4899/ffffff?text=C",
        tag: "Free",
        requiresLogin: false,
        endorsed: false,
      },
      {
        ...
        desc: "Let customers view prices in their preferred currency.",
        iconUrl: "https://placehold.co/48x48/a855f7/ffffff?text=X",
        tag: "Pro",
        requiresLogin: true,
        endorsed: false,
      },
      {
        title: "BlogLift",
        desc: "AI-powered blogging and SEO optimization for merchants.",
        iconUrl: "https://placehold.co/48x48/23b5b5/000000?text=B",
        tag: "Our App",
        requiresLogin: true,
        endorsed: true,
        ours: true,
  ...
  atlassian: {
    ...
    items: [
      {
        title: "CardLytics",
        desc: "Enhance Trello with dynamic dashboard cards and real-time visuals.",
        iconUrl: "https://placehold.co/48x48/0ea5e9/ffffff?text=C",
        tag: "Pro",
        requiresLogin: true,
        endorsed: false,
      },
      {
        title: "Secure Notes",
        desc: "Add private, encrypted notes directly within Trello cards.",
        iconUrl: "https://placehold.co/48x48/22c55e/ffffff?text=S",
        tag: "Free",
        requiresLogin: false,
        endorsed: false,
      },
      {
        title: "Progress",
        desc: "Powerful Trello time and goal-tracking Power-Up.",
        iconUrl: "https://placehold.co/48x48/84cc16/000000?text=P",
        tag: "Pro",
        requiresLogin: true,
        endorsed: false,
      },
      {
        title: "Summify",
        desc: "Transforms complex Trello boards into professional dashboards.",
        iconUrl: "https://placehold.co/48x48/6b7280/ffffff?text=S",
        tag: "Pro",
        requiresLogin: true,
        endorsed: false,
      },
      {
        title: "Comment AI",
        desc: "Integrate AI directly into Trello to generate smart comments.",
        iconUrl: "https://placehold.co/48x48/23b5b5/000000?text=C",
        tag: "Our App",
        requiresLogin: true,
        endorsed: true,
        ours: true,
      ...
      {
        title: "Pause Card",
        desc: "Temporarily hide Trello cards and bring them back on schedule.",
        iconUrl: "https://placehold.co/48x48/f59e0b/000000?text=P",
        tag: "Free",
        requiresLogin: false,
        endorsed: false,
      },
  ...
  chrome: {
    ...
    items: [
      {
        title: "Tab Hoarder Pro",
        desc: "Save, organize, and resurface your tabs intelligently.",
        iconUrl: "https://placehold.co/48x48/3b82f6/ffffff?text=T",
        tag: "Free",
        requiresLogin: false,
        endorsed: false,
      },
      {
        title: "AI Summarizer",
        desc: "One-click AI summaries for any page you're reading.",
        iconUrl: "https://placehold.co/48x48/23b5b5/000000?text=A",
        tag: "Our App",
        requiresLogin: true,
        endorsed: true,
...
const TESTIMONIALS = [
  {
    name: "Leila Nasser",
    role: "Product Designer @ Mindful",
    avatar: "LN",
    quote:
      "QR Code Canvas from Explified is now a permanent fixture in every Figma project. It's that good.",
    app: "QR Code Canvas",
    platform: "figma",
    color: BRAND,
  },
  {
    ...
    avatar: "JO",
    quote:
      "AnnounceMate doubled my click-through rate on promos. The analytics dashboard alone is worth it.",
    app: "AnnounceMate",
    platform: "shopify",
    color: "#96bf48",
  },
  {
    name: "Riya Mehta",
    role: "Project Manager @ Orbit",
    avatar: "RM",
    quote:
      "Comment AI in Trello turned our weekly syncs into 5-minute check-ins. Absolute game changer.",
    app: "Comment AI",
    platform: "atlassian",
    color: "#0052cc",
  },
    ...
    {open && (
      ...
      >
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-10 w-9 h-9 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center text-gray-500 hover:text-white transition-all"
          >
          ...
          <div className="relative p-8 text-center">
            <div
              ...
              style={{ background: BRAND_DIM, border: `1px solid ${BRAND}33` }}
            >
            ...
            <p className="text-gray-400 text-sm mb-7 leading-relaxed max-w-xs mx-auto">
              Sign in or create a free account to access all marketplace apps,
              track installs, and manage your workspace.
            </p>
            <button
              onClick={() => {
                onLogin();
              ...
              style={{
                background: `linear-gradient(135deg, #23b5b5, #1a9090)`,
              }}
            >
...
const TagPill = ({ tag }) => {
  const tagColors = {
    "Our App": {
      bg: `rgba(35,181,181,0.15)`,
      color: BRAND,
      border: `rgba(35,181,181,0.35)`,
    },
    Pro: {
...
const AppCard = ({ app, platform, index }) => {
  ...
  return (
    <motion.div
      ...
      style={{
        borderColor: app.ours ? `${BRAND}35` : "rgba(255,255,255,0.08)",
        boxShadow: app.ours ? `0 0 30px ${BRAND}10` : "none",
      }}
    >
      {app.ours && (
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(35,181,181,0.08),transparent_60%)] pointer-events-none" />
      )}
      <div
        className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none rounded-2xl"
        style={{
          background: `radial-gradient(circle at 30% 0%, ${meta.color}0A 0%, transparent 65%)`,
        }}
      />
      ...
      {/* Pricing models — stacked vertically */}
      {Array.isArray(app.pricingModels) && app.pricingModels.length > 0 && (
        <div
          className="flex flex-col gap-2 pt-3 mt-1 border-t"
          style={{ borderColor: "rgba(255,255,255,0.06)" }}
          onClick={(e) => e.stopPropagation()}
        >
          {app.pricingModels.map((plan) => (
            <div
            ...
            >
              ...
              {plan.description && (
                <p className="text-[11px] leading-relaxed text-gray-400 mb-1.5">
                  {plan.description}
                </p>
              )}
...
const MarketplaceExplorer = () => {
  ...
  const platforms = Object.entries(productsData)
    ...
    .map(([key, val]) => {
      ...
      const normalizedItems = rawItems.map((item, idx) =>
        normalizeCMSApp(item, normalizedKey, idx),
      );
  ...
  const meta = activePlatform
    ? PLATFORM_META[activePlatform.key] || {
        color: BRAND,
        bg: BRAND_DIM,
        label: activePlatform.title,
      }
    : { color: BRAND, bg: BRAND_DIM, label: "" };
  const [ref, inView] = useInViewOnce("40px");

  return (
    <section
      ref={ref}
      className="relative py-24 px-6 border-t border-white/5 bg-[#050505]"
    >
      <div
      ...
      >
        <motion.div variants={fadeUp} custom={0} className="text-center mb-14">
          ...
          >
            Explified builds and endorses apps for the tools your team runs on —
            Figma, Shopify, Trello, Chrome, and more.
          </p>
        </motion.div>
              ...
              >
                {p.imageUrl ? (
                  ...
                  <div
                    ...
                    style={{ background: isActive ? m.color : "#374151" }}
                  />
                )}
                {p.title}
                <span
        ...
        {activePlatform && (
          ...
          >
            <div
              ...
              style={{
                background: `radial-gradient(ellipse at left, ${meta.color}08, transparent 60%)`,
              }}
            />
            <div className="flex items-center gap-4 flex-wrap sm:flex-nowrap">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm font-semibold">
                  {currentItems?.length || 0} apps verified & endorsed by
                  Explified
                </p>
              </div>
        ...
        >
          <p
            className="text-sm text-center font-medium flex items-center gap-2"
            style={{ color: BRAND }}
          >
            <LucideIcons.Info
              size={14}
              ...
              style={{ flexShrink: 0 }}
            />
            Pro plan pricing for each product is available on its respective
            marketplace listing.
          </p>
        </motion.div>
      </motion.div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(35,181,181,0.5) 1px, transparent 1px), linear-gradient(90deg, rgba(35,181,181,0.5) 1px, transparent 1px)",
