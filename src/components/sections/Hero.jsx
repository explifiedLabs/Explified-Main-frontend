...
const Logos = {
  Zoom: () => (
    <svg viewBox="0 0 24 24" fill="none" className="w-full h-full p-2.5">
      <path d="M14 8C14 7.44772 13.5523 7 13 7H4C3.44772 7 3 7.44772 3 8V16C3 16.5523 3.44772 17 4 17H13C13.5523 17 14 16.5523 14 16V8Z" fill="#2D8CFF" />
  ...
  Teams: () => (
    <svg viewBox="0 0 24 24" fill="none" className="w-full h-full p-2.5">
      ...
      <path d="M8 10C8 8.89543 8.89543 8 10 8H14C15.1046 8 16 8.89543 16 10V14H8V10Z" fill="white" fillOpacity="0.8" />
  ...
  Outlook: () => (
    <svg viewBox="0 0 24 24" fill="none" className="w-full h-full p-2.5">
      ...
      <path d="M15 7H19C19.55 7 20 7.45 20 8V9L12 14L4 9V8C4 7.45 4.45 7 5 7H9" fill="white" fillOpacity="0.2" />
    </svg>
  ),
  Word: () => (
    <svg viewBox="0 0 24 24" fill="none" className="w-full h-full p-2.5">
      <rect x="3" y="4" width="18" height="16" rx="2" fill="#2B579A" />
      <path d="M7 8L9 16L12 10L15 16L17 8" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  Figma: () => (
    <svg viewBox="0 0 24 24" fill="none" className="w-full h-full p-2.5">
  ...
  Slack: () => (
    <svg viewBox="0 0 24 24" fill="none" className="w-full h-full p-2.5">
      <path d="M6 14C4.89543 14 4 13.1046 4 12C4 10.8954 4.89543 10 6 10H8V14H6Z" fill="#E01E5A" />
      <path d="M10 6C10 4.89543 10.8954 4 12 4C13.1046 4 14 4.89543 14 6V8H10V6Z" fill="#36C5F0" />
      <path d="M18 10C19.1046 10 20 10.8954 20 12C20 13.1046 19.1046 14 18 14H16V10H18Z" fill="#2EB67D" />
      <path d="M14 18C14 19.1046 13.1046 20 12 20C10.8954 20 10 19.1046 10 18V16H14V18Z" fill="#ECB22E" />
  ...
  <span className="text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-gray-400">
    Faster Than Ever
      ...
      <motion.div 
        ...
        className="relative w-full overflow-hidden mt-20 mb-20 md:mb-24 z-20 flex flex-col items-center"
      >
        {/* Added Integration Tag with Spacing */}
